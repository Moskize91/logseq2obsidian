...
def test_full_conversion():
    ...
    for md_file in md_files:
        ...
        try:
            ...
            print(f"   原始: 页面链接{conversion_summary['original']['page_links']}个, 块引用{conversion_summary['original']['block_refs']}个")
            print(f"   转换: 页面链接{conversion_summary['converted']['page_links']}个, 注释{conversion_summary['converted']['block_refs']}个")
